...
const Projects = () => {
  return (
    <section
      id="my-works"
      className="relative min-h-screen lg:pt-12 flex flex-col-reverse lg:flex-row items-center justify-center lg:justify-between gap-6 md:gap-16 lg:gap-18"
    >
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-2 gap-2 md:gap-4 lg:w-[50%] rounded-[5px]">
